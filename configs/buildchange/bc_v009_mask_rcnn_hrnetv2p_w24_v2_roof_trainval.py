...
model = dict(
    type='MaskRCNN',
    pretrained='/mnt/lustre/wangjinwang/.torch/models/x4hrnet_crop640_s0922_building.pth',
    backbone=dict(
        ...
        group=None, 
        sync_stats=False),
    neck=dict(type='HRFPN', in_channels=[24, 48, 96, 192], out_channels=256),
    rpn_head=dict(
        type='RPNHead',
        in_channels=256,
        feat_channels=256,
...
img_norm_cfg = dict(
    mean=[127, 127, 127], std=[127*0.25, 127*0.25, 127*0.25], to_rgb=True)
train_pipeline = [
...
log_level = 'INFO'
work_dir = './work_dirs/bc_v009_mask_rcnn_hrnetv2p_w24_v2_roof_trainval'
load_from = None
resume_from = './work_dirs/bc_v009_mask_rcnn_hrnetv2p_w24_v2_roof_trainval/epoch_4.pth'
workflow = [('train', 1)]
