...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(1280, 1280), (1024, 1024), (768, 768)],
        keep_ratio=True,
...
evaluation = dict(interval=2, 
                  metric=['hbb', 'obb'], 
                  submit_path='./results/dota/dota_v018_centermap_net_r101_v2_trainval_ms', 
...
log_level = 'INFO'
work_dir = './work_dirs/dota_v018_centermap_net_r101_v2_trainval_ms'
load_from = None
resume_from = None
workflow = [('train', 1)]
