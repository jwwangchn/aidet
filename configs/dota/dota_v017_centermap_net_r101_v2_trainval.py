...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/dota_trainval_v2_best_keypoint.json',
...
evaluation = dict(interval=2, 
                  ...
                  excel='./results/dota/dota_v017_centermap_net_r101_v2_trainval/dota_v017_centermap_net_r101_v2_trainval.xlsx', 
                  jsonfile_prefix='./results/dota/dota_v017_centermap_net_r101_v2_trainval')
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/dota_v017_centermap_net_r101_v2_trainval'
load_from = None
resume_from = None
workflow = [('train', 1)]
