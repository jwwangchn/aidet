...
data = dict(
    ...
    train=dict(
        ...
        seg_prefix=data_root + 'trainset_pseudo_segmentation/',
        heatmap_weight_prefix=data_root + 'trainset_heatmap_weight/',
...
log_level = 'INFO'
work_dir = './work_dirs/dota_v009_centermap_net_r50_v1_train_rotation'
load_from = None
resume_from = None
workflow = [('train', 1)]
