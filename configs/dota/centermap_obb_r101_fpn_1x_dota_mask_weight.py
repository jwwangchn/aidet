...
evaluation = dict(interval=2, 
                  metric=['hbb', 'obb'], 
                  submit_path='./results/dota/centermap_obb_r101_fpn_1x_dota_mask_weight', 
                  annopath='./data/dota/v0/test/labelTxt-v1.0/{:s}.txt', 
                  imageset_file='./data/dota/v0/test/testset.txt', 
                  excel='./results/dota/centermap_obb_r101_fpn_1x_dota_mask_weight/centermap_obb_r101_fpn_1x_dota_mask_weight.xlsx', 
                  jsonfile_prefix='./results/dota/centermap_obb_r101_fpn_1x_dota_mask_weight')
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/centermap_obb_r101_fpn_1x_dota_mask_weight'
load_from = None
resume_from = None
workflow = [('train', 1)]
