...
evaluation = dict(interval=2, 
                  metric=['hbb', 'obb'], 
                  submit_path='./results/dota/centermap_obb_r50_fpn_1x_dota_rotate', 
                  annopath='./data/dota/v0/test/labelTxt-v1.0/{:s}.txt', 
                  imageset_file='./data/dota/v0/test/testset.txt', 
                  excel='./results/dota/centermap_obb_r50_fpn_1x_dota_rotate/centermap_obb_r50_fpn_1x_dota_rotate.xlsx', 
                  jsonfile_prefix='./results/dota/centermap_obb_r50_fpn_1x_dota_rotate')
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/centermap_obb_r50_fpn_1x_dota_rotate'
load_from = None
resume_from = None
workflow = [('train', 1)]
