...
evaluation = dict(interval=2, 
                  metric=['hbb', 'obb'], 
                  submit_path='./results/dota/dota_v015_centermap_net_r101_v4_trainval', 
                  annopath='./data/dota/v0/test/labelTxt-v1.0/{:s}.txt', 
                  imageset_file='./data/dota/v0/test/testset.txt', 
                  excel='./results/dota/dota_v015_centermap_net_r101_v4_trainval/dota_v015_centermap_net_r101_v4_trainval.xlsx', 
                  jsonfile_prefix='./results/dota/dota_v015_centermap_net_r101_v4_trainval')
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/dota_v015_centermap_net_r101_v4_trainval'
load_from = None
resume_from = None
workflow = [('train', 1)]
